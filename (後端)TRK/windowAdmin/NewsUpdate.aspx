<%@ Page Title="" Language="C#" MasterPageFile="~/windowAdmin/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="NewsUpdate.aspx.cs" Inherits="windowCompany_companyUpdate" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <div class="row">
    ...
    <div class="col-lg-6">
        ...
        <div class="form-group">
            <asp:Button ID="btnNewsUpdate" runat="server" Text="更新" CssClass="btn btn-default" OnClick="btnNewsUpdate_Click" OnClientClick="return confirm('您確定要重新上架嗎?')"/>
