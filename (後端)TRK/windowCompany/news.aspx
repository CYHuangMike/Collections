<%@ Page Title="" Language="C#" MasterPageFile="~/windowCompany/MasterPageCC.master" AutoEventWireup="true" CodeFile="news.aspx.cs" Inherits="news" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">發布最新消息</h1>
        </div>
    </div>
    <!-- 帳號管理 -->
    <div class="col-lg-6">
        <div class="form-group">
            <label>廠商名稱</label>
            <asp:TextBox ID="txtCounterInput" runat="server" CssClass="form-control" Enabled="False"></asp:TextBox>
        </div>
        <div class="form-group">
            <label>標題</label>
